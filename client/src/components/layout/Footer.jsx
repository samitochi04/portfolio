...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-black via-gray-800 to-black text-white">
      ...
      <button
        ...
        className="fixed bottom-6 left-6 p-3 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all duration-300 hover:scale-110 z-40"
